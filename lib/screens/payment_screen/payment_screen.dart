                  ...
                  builder: (context) => AlertDialog(
                      ...
                      title:Column(
                        ...
                        children: [
                         ...
                         Padding(padding: EdgeInsets.only(left: AppConstants.HP,bottom: AppConstants.HP,right: AppConstants.HP),
                         child:  RichText(
                           textAlign: TextAlign.justify,
                           text: TextSpan(
                               children: [
                                 WidgetSpan(child: Image.asset('assets/images/warning.png',height: 20,width: 20,)),
