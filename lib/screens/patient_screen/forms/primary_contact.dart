  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: MultiBlocListener(listeners: [
          BlocListener<GetPatientContactCubit, GetPatientContactState>(
          ...
          BlocListener<SavePatientContactCubit, SavePatientContactState>(
              listener: (context, state) async {
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                                ...
                                                border: Border.all(width: 1.5, color: selectedPhoneType == primaryPhone[index] ? AppColor.primarySeedColor : AppColor.secondarySeedColor)),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    shape: BoxShape.circle,
                                                    color: selectedPhoneType == primaryPhone[index] ? AppColor.primarySeedColor : Colors.transparent,
                                                  ),
                                                )
                                              ],
                                            ),
                                          ...
                                          SizedBox(width: 16),
                                          Text(primaryPhone[index],
                                              style: GoogleFonts.inter(
                                                  fontSize: AppConstants.SMALL, fontWeight: FontWeight.w500, color: brightness == Brightness.dark ? AppColor.whiteColor : AppColor.blackColor))
                                        ],
                                      )));
                            },
                          ),
                                      ...
                                      child: Row(
                                        children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(
                                                shape: BoxShape.circle,
                                                border: Border.all(width: 1.5, color: selectedRelationship == relation[index] ? AppColor.primarySeedColor : AppColor.secondarySeedColor)),
                                            padding: EdgeInsets.all(2),
                                            child: Column(
                                              mainAxisAlignment: MainAxisAlignment.center,
                                              children: [
                                                Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    shape: BoxShape.circle,
                                                    color: selectedRelationship == relation[index] ? AppColor.primarySeedColor : Colors.transparent,
                                                  ),
                                                )
                                              ],
                                            ),
