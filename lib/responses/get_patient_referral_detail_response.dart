class PatientReferralDetailResponse {
  ...
  factory PatientReferralDetailResponse.fromJson(Map<String, dynamic> json) {
    return PatientReferralDetailResponse(
